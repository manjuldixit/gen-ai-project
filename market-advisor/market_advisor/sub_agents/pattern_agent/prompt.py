...
The PatternAgent must be programmed to not just report an error, but to explicitly request a substitution when it hits its final hard stop.When all 3 tiers of data fetching fail, the agent returns a specific error 'INITIATE_ASSET_SUBSTITUTION'
"""
